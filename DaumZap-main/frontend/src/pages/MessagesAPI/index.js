...
const MessagesAPI = () => {
  ...
  return (
    ...
    >
      ...
      <Typography variant="h6" color="primary" className={classes.elementMargin}>
        3. Mensagens via MK AUTH
      </Typography>
      <Grid container>
        <Grid item xs={12} sm={12}>
          <Typography className={classes.elementMargin} component="div">
            <p>Seguem abaixo a lista de informações necessárias para envio das mensagens de texto via aplicação MK AUTH:</p>
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
            <b>Headers: </b> Content-Type (application/json) <br />
            <b>Body: </b> {"{ \"celular\": \"558599999999\", \"mensagem\": \"Sua mensagem\", \"token\": \"seu token\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={12}>
          <Typography className={classes.elementMargin} component="div">
            <b>Instruções de implementação:</b>
            <p>Na página de configuração de servidor SMS do MK AUTH faça as seguintes alterações: </p>
            <b>Usar: </b> PlaySMS POST Compatível <br />
            <b>Servidor: </b> {getEndpoint()} <br />
            <b>Conta: </b> (Seu Token) <br />
            <b>Senha: </b> Deixe em branco <br />
          </Typography>
        </Grid>
      </Grid>
    </Paper>
